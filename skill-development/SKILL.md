...
description: "Create, test, and audit skills for Cortex Code. Use when: creating new skills, capturing session work as reusable workflows, reviewing skill quality, testing skills with eval prompts. Triggers: create skill, build skill, new skill, summarize session, capture workflow, audit skill, review skill, test skill, evaluate skill."
---
