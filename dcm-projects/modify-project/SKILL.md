---
name: modify-project
description: "Modifies existing DCM projects with or without local source code. Use when user wants to modify, update, add tables, edit definitions, download sources, or import existing objects into a DCM project. Triggers: modify dcm, update project, add table, edit definitions, download project sources, import existing objects."
---
...
**⚠️ For bulk imports (entire schema, many objects, cross-account migration):**
Load [../bulk-import/SKILL.md](../bulk-import/SKILL.md) instead - it provides automated discovery scripts and batch processing workflows.

**For individual object adoption (few objects):**
