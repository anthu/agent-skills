---
name: create-project
description: "Creates new DCM projects from scratch with proper structure and validation. Use when user wants to create a new project, set up DCM, start from scratch, or build infrastructure. Triggers: new project, create dcm project, set up dcm, start from scratch, build infrastructure."
---
...
4. **Multi-project architecture?**
   - Is this part of a hierarchical setup (platform + team projects)?
   - Will this project grant `CREATE DCM PROJECT` to team roles?
   - **→ Load** [../multi-project/SKILL.md](../multi-project/SKILL.md) for platform/team patterns
   - See [../reference/multi-project-patterns.md](../reference/multi-project-patterns.md) for templates
...
Refer to [../reference/project-structure.md](../reference/project-structure.md) for the best practice directory structure.

### Step 5: Create manifest.yml

Use ONLY the fields shown in these examples. See [../reference/project-structure.md](../reference/project-structure.md) for the full v2 schema.
